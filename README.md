...
| :--- | :--- |
| ![Mnemonics](notes/images/mnemonics_exam_tricks.jpg) | **Exam Mnemonics & Tricks:** LINE assumptions, hypothesis decision rule, skewness intuition |
| ![Formulas](notes/images/formulas_rote_card.jpg) | **Formulas Memory Card:** Variance (n-1), Tukey IQR, Bayes' rule, CLT SE, Entropy, F1 |
| ![Traps & Hacks](notes/images/exam_traps_and_hacks.jpg) | **Exam Traps & Hacks:** r=0 trap, accuracy paradox, Power BI Column vs Measure |
| ![Lifecycle](notes/images/lifecycle_infographic.jpg) | **Analytics Life Cycle:** Discovery ➔ Preparation ➔ Model Planning ➔ Building ➔ QA ➔ Deployment |
| ![Distributions](notes/images/probability_distributions.jpg) | **Distributions & CLT:** Normal, Binomial, Poisson + Central Limit Theorem convergence |
| ![Decision Tree](notes/images/decision_trees_segmentation.jpg) | **Decision Trees & Segmentation:** 2D feature partition, Information Gain, tree-to-rules |
| ![Classifier Matrix](notes/images/classifier_evaluation_matrix.jpg) | **Classifier Evaluation Matrix:** Confusion Matrix, Precision/Recall, ROC-AUC curve |
| ![Power BI](notes/images/powerbi_pipeline_architecture.jpg) | **Power BI Pipeline:** Power Query ETL ➔ Star Schema Modeling ➔ DAX Measures ➔ Dashboards |
